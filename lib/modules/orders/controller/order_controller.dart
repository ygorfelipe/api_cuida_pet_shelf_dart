...
class OrderController {
  ...
  Future<Response> getAll(Request request) async {
    ...
    return Response.notFound('Orders not found',
  ...
  Future<Response> getById(Request request) async {
    try {
      ...
      if (order != null) {
        ...
        return Response.notFound('Order $id not found',
            headers: {'Content-Type': 'text/json'});
      }
    } catch (e, s) {
  ...
  Future<Response> save(Request request) async {
    ...
    return Response.ok(orderSaved.toJson(),
        headers: {'Content-Type': 'text/json'});
  }
  ...
  Future<Response> delete(Request request) async {
    ...
    return Response.ok(orderDeleted.toJson(),
        headers: {'Content-Type': 'text/json'});
  }
